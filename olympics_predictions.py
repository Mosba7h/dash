...
with open('pkl_data/one_hot_encoder_sec.pkl', 'rb') as f:
...
with open('pkl_data/one_hot_encoder_main.pkl', 'rb') as f:
    ...
    layout = dbc.Card(
        html.Div([
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader("The Top 5 Athletes in the predected sport", className='display-5', style={
                            'font_weight': 'bold',
                            'color': 'black',
                            'text-align': 'left',
                            'font-size': '20px'
